...
class TestWin(QWidget):
    ...
    def next_click(self):
        self.hide()
        self.tw = FinalWin(self.pole5.text(),self.pole2.text(),self.pole3.text(),self.pole4.text())
